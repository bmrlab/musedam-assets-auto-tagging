    ...
    <>
      <div className="flex min-h-[calc(100dvh-120px)] flex-1 flex-col pb-5">
        <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
          ...
          <div className="flex w-full flex-col gap-3 sm:flex-row xl:w-auto">
            <div className="relative w-full sm:w-[200px]">
              ...
              <Input
                className="h-8 rounded-[8px] pl-10"
            ...
            <Button type="button" variant="outline" className="h-8 rounded-[8px] px-4" disabled>
            ...
            <Button type="button" className="h-8 rounded-[8px] px-4" onClick={handleOpenCreate}>
        ...
        <div className="mt-6 flex min-h-0 flex-1 flex-col gap-4">
          <div className="rounded-[8px] border bg-background px-6 py-4">
            <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
            ...
            {filteredLogos.length === 0 ? (
              ...
              <div className="flex min-h-0 flex-1 flex-col">
                <div className="flex-1 overflow-x-auto">
                  <table className="min-w-full table-fixed [&_th]:leading-5 [&_th]:align-middle [&_td]:leading-5 [&_td]:align-middle">
                    <thead>
                    ...
                    <tbody>
                      {currentPageLogos.map((logo) => {
                        ...
                        return (
                          ...
                          <td className="px-4 py-5 align-middle text-[14px] text-basic-8">
                              {logo.logoTypeName}
                            </td>
                            <td className="px-4 py-5 align-middle">
                              ...
                              <div className="flex flex-wrap gap-2">
                                {logo.tags.length > 0 ? (
                                  logo.tags.map((tag) => (
                                    <span
                                      key={tag.id}
                                      className="inline-flex items-center rounded-sm border border-[#d9e2f2] bg-[#f7f9fc] px-2 py-1 text-xs text-basic-8"
                                    >
                                      {tag.tagPath.join(" > ")}
                                    </span>
                                  ))
                            ...
                            <td className="px-4 py-5 align-middle">
                              <div className="space-y-2">
                                <div className="flex items-center gap-3">
                                  <span
                                  className={`inline-flex items-center gap-1 rounded-sm border px-2 py-1 text-xs ${statusMeta.className}`}
                                  >
                                    <StatusIcon
                                      className={
                          ...
                          <td className="px-4 py-5 align-middle whitespace-nowrap text-[14px] text-basic-8">
                ...
                <div className="mt-auto flex flex-col gap-4 border-t px-6 py-4 xl:flex-row xl:items-center xl:justify-between">
                  ...
                  className="h-8 w-[230px] rounded-[8px]"
                  />
                  ...
                  <div className="flex items-center gap-3 self-end">
                    <div className="flex items-center gap-1">
                      ...
                      <div className="inline-flex h-8 min-w-8 items-center justify-center rounded-[8px] border border-primary px-3 text-sm text-primary">
                        {safeCurrentPage}
                      </div>
                      <Button
                        type="button"
