...
import { PersonImageItem } from "./types";

type PersonImageHoverCardProps = {
  image: PersonImageItem;
  alt: string;
  children: ReactNode;
  className?: string;
};

export default function PersonImageHoverCard({
  image,
  alt,
  children,
  className,
}: PersonImageHoverCardProps) {
