            ...
            <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 text-sm text-muted-foreground mt-1">
                        <span>{result.asset.extension.toUpperCase()} · {formatFileSize(result.asset.size)} </span>
                        {result.asset.materializedPath && <span>· <FolderIcon className="size-[12px]" /> {result.asset.materializedPath}</span>}
                    </div>
